	...
	<div class="system-role-container layout-padding">
		<div class="system-role-padding layout-padding-auto layout-padding-view">
			...
			<el-table :data="state.tableData.data" v-loading="state.tableData.loading" style="width: 100%">
				...
				<el-table-column label="AI建议" show-overflow-tooltip align="center">
					<template #default="scope">
						<el-popover placement="top" :width="400" trigger="hover" v-if="scope.row.suggestion">
							<template #reference>
								<div class="suggestion-preview">{{ scope.row.suggestion ? scope.row.suggestion.substring(0, 30) + '...' : '-' }}</div>
							</template>
							<div v-html="scope.row.suggestion" class="markdown-body"></div>
						</el-popover>
						<span v-else>-</span>
					</template>
				</el-table-column>
